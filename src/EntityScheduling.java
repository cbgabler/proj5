...
public abstract class EntityScheduling extends Entity{
    private double actionPeriod;
    private double animationPeriod;
    public EntityScheduling(String id, Point position, List<PImage> images, double actionPeriod, double animationPeriod){
